...
export const MapObjectConfig = {
	antialias: true,
	container: "mapboxBox",
	center: [121.24074420925105,24.957577217660024],
	maxBounds: [
	 [120.94536399774722, 24.582996391329175], // Southwest coordinates
	 [121.49572794959346, 25.19335391857962], // Northeast coordinates
	],
	zoom: 10,
	minZoom: 8,
	maxZoom: 22,
...
export const TaipeiBuilding = {
	...
	"source-layer": "tp_building_height84-7g7jir",
	type: "fill-extrusion",
	minzoom: 14,
	paint: {
...
export const maplayerCommonLayout = {
	...
	"symbol-triangle_green": {
		"icon-image": "triangle_green", // 綠色三角形(圖案名稱)
	},
	...
	"symbol-eco-friendly-fabric": {
		"icon-image": "eco-friendly-fabric",
		"icon-size": [
			"interpolate",
			["linear"],
			["zoom"],
